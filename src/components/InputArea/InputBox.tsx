import { BrainCog, Highlighter, OctagonPause, Send } from "lucide-react";
...
export default function InputBox({ input, setInput, onSend, height, disabled, showHighlights, setShowHighlights }: InputBoxProps) {
    return (
        <div>
            {/* <p>{input}</p> */}
            <div className="max-w-3xl md:mx-auto text-base font-sans lg:px-0 dark:bg-[#1d1e20] md:pb-4 pb-3 w-screen px-2 rounded-t-3xl">
                <div className="flex flex-col items-end rounded-3xl dark:bg-[#303335] bg-neutral-100 p-2 w-full">
                    <TextInput input={input} setInput={setInput} height={height} onSend={onSend} />
                    <div className="flex flex-row justify-between w-full mt-0">
                        ...
                        <div className="flex flex-row justify-center items-center">
                            <p className="text-xs dark:text-neutral-400 mr-3 hidden sm:block">Use <span className="dark:text-white text-black">shift + return</span> for new line</p>
                            <Button
